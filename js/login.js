...
function autenticarUsuario(usuario, password) {
    ...
    if (usuarios) {
      ...
      if (usuarioValido) {
        ...
        document.querySelector("#dbtn .formulario__input-error").classList.remove("formulario__input-error-activo");
        formulario.reset();
        //miFormularioLogin.reset();
      } else {
        console.log("Usuario no válido");
        document.querySelector("#dbtn .formulario__input-error").classList.add("formulario__input-error-activo");
      }
    } else {
